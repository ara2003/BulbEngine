...
public final class BasicFont implements Font {
	...
	public void drawString(final float x, final float y, final String whatchars) {
		this.drawString(x, y, whatchars, com.greentree.engine.bulbgl.Color.white);
	}
	
	@Override
	public void drawString(final float x, final float y, final String whatchars,
			final com.greentree.engine.bulbgl.Color color) {
		this.drawString(x, y, whatchars, color, 0, whatchars.length() - 1);
	}
	
	@Override
	public void drawString(final float x, final float y, final String whatchars,
			final com.greentree.engine.bulbgl.Color color, final int startIndex, final int endIndex) {
		color.bind();
		fontTexture.bind();
