...
public class MouseEvent implements Event {
	...
	public MouseEvent reset(EventType eventType, int x1, int y1, int x2, int y2) {
		this.type = eventType;
		this.x1 = x1;
		this.x2 = x2;
		this.y1 = y1;
	...
	public MouseEvent reset(EventType eventType, int button, int x, int y) {
		this.type = eventType;
		this.x1 = x;
		this.x2 = y;
		this.button = button;
