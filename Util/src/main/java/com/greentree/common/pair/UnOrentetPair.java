...
public class UnOrentetPair<T> extends Pair<T, T> {
	...
	public boolean equals(Object obj) {
		...
		if(first.equals(other.first)) return second.equals(other.second);
		else
			if(second.equals(other.second)) return first.equals(other.first);
			else
				if(first.equals(other.second)) return second.equals(other.first);
				else
					if(second.equals(other.first)) return first.equals(other.second);
					else
						return false;
	}
