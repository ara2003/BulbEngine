...
public final class Graphics {
	...
	public static void clear() {
		Graphics.GL.glClear(GraphicsI.GL_COLOR_BUFFER_BIT);
	}
	...
	public static void clearClip() {
		Graphics.GL.glDisable(GraphicsI.GL_SCISSOR_TEST);
	}
	
	public static void clearWorldClip() {
		Graphics.GL.glDisable(GraphicsI.GL_CLIP_PLANE0);
		Graphics.GL.glDisable(GraphicsI.GL_CLIP_PLANE1);
		Graphics.GL.glDisable(GraphicsI.GL_CLIP_PLANE2);
		Graphics.GL.glDisable(GraphicsI.GL_CLIP_PLANE3);
	}
	...
	public static Color getPixel(final int x, final int y) {
		Graphics.GL.glReadPixels(x, Graphics.screenHeight - y, 1, 1, GraphicsI.GL_RGBA, GraphicsI.GL_UNSIGNED_BYTE,
				Graphics.readBuffer);
	...
	public static void setDrawMode(final int mode) {
		...
		if(Graphics.currentDrawingMode == Graphics.MODE_NORMAL) {
			...
			Graphics.GL.glBlendFunc(GraphicsI.GL_SRC_ALPHA, GraphicsI.GL_ONE_MINUS_SRC_ALPHA);
		}
		...
		if(Graphics.currentDrawingMode == Graphics.MODE_ALPHA_BLEND) {
			...
			Graphics.GL.glBlendFunc(GraphicsI.GL_DST_ALPHA, GraphicsI.GL_ONE_MINUS_DST_ALPHA);
		}
		if(Graphics.currentDrawingMode == Graphics.MODE_COLOR_MULTIPLY) {
			Graphics.GL.glEnable(3042);
			Graphics.GL.glColorMask(true, true, true, true);
			Graphics.GL.glBlendFunc(GraphicsI.GL_ONE_MINUS_SRC_COLOR, GraphicsI.GL_SRC_COLOR);
		}
		...
		if(Graphics.currentDrawingMode == Graphics.MODE_SCREEN) {
			Graphics.GL.glEnable(3042);
			Graphics.GL.glColorMask(true, true, true, true);
			Graphics.GL.glBlendFunc(1, GraphicsI.GL_ONE_MINUS_SRC_COLOR);
		}
	}
	...
	public static void drawVector(float x, float y, float vx, float vy) {
