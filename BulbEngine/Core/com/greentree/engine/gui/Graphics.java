...
import com.greentree.util.math.FastTrig;
...
public final class Graphics {
	...
	public static void drawOval(final Point p, final float d, final float d2) {
		if(p == null) return;
	...
	public static void drawShape(final Shape s) {
		Graphics.currentColor.bind();
		TextureImpl.bindNone();
		Graphics.LSR.start();
	...
	public static void fillOval(final Point c, final float f, final float g) {
