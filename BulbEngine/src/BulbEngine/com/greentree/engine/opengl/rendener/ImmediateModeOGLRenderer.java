...
public class ImmediateModeOGLRenderer implements SGL {
	...
	public ImmediateModeOGLRenderer() {
		current = new float[]{1.0f,1.0f,1.0f,1.0f};
		alphaScale = 1.0f;
	}
	...
	public void glColor4f(final float r, final float g, final float b, float a) {
		a *= alphaScale;
		GL11.glColor4f(current[0] = r, current[1] = g, current[2] = b, current[3] = a);
	}
	...
	@Override
	public void glTexImage2D(final int target, final int i, final int dstPixelFormat, final int width, final int height,
	...
	@Override
	public void glTexSubImage2D(final int glTexture2d, final int i, final int pageX, final int pageY, final int width,
			final int height, final int glBgra, final int glUnsignedByte, final ByteBuffer scratchByteBuffer) {
